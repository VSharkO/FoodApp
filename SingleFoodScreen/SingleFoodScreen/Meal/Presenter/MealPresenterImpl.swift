...
public class MealPresenterImpl: MealPresenter{
    ...
    public func updateMeal(name: String, photo: UIImage, rating: Int, index: Int) {
    ...
    public func addMeal(name: String, photo: UIImage, rating: Int) {
    ...
    public init(view: MealViewController) {
        self.view = view
    }
}
